          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                {activeWorkspace ? (
                  <>
                    <div className="workspace-switcher-initial flex aspect-square size-8 items-center font-semibold justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground">
            ...
            >
              ...
              {workspaces?.map((workspace) => (
                ...
                >
                  <div className="workspace-switcher-initial flex size-6 items-center justify-center rounded-sm border">
