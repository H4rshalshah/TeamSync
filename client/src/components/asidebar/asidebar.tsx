...
const Asidebar = () => {
  ...
  return (
    <>
      <Sidebar collapsible="icon" className="workspace-sidebar-shell">
            ...
            <SidebarMenuItem>
              {isLoading ? (
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent
                    className="logout-menu-content w-[--radix-dropdown-menu-trigger-width] min-w-56"
                    side={"bottom"}
                    align="start"
                    sideOffset={4}
                  >
                    <DropdownMenuItem
                      className="logout-menu-action"
