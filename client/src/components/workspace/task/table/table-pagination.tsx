    ...
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 px-2">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center space-y-2 lg:space-x-8 lg:space-y-0">
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            <SelectTrigger className="task-page-size h-8 w-[70px]">
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center space-x-2">
            <Button
              variant="outline"
              className="task-pagination-button task-pagination-prev"
            ...
            <Button
              variant="outline"
              className="task-pagination-button task-pagination-next"
              onClick={() => handlePageChange(pageIndex + 1)}
